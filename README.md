...
| `zmk-config/`, `zmk-module/`, `zephyr/module.yml` | ZMK bring-up (Phase 1 of `zmk_plan.md`) targeting a Keychron K3 Ultra 8K over Bluetooth/USB — currently builds against the Q3 Ultra 8K as a stand-in, since no public K3 Ultra 8K shield exists yet. Unverified against real hardware/toolchain — see `zmk-config/README.md` |
